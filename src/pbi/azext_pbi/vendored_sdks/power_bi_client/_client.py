...
class PowerBIClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype datasets: power_bi_client.operations.DatasetsOperations
    :ivar users: UsersOperations operations
    :vartype users: power_bi_client.operations.UsersOperations
    :ivar imports: ImportsOperations operations
    :vartype imports: power_bi_client.operations.ImportsOperations
    :ivar reports: ReportsOperations operations
    :vartype reports: power_bi_client.operations.ReportsOperations
    :ivar dashboards: DashboardsOperations operations
    :vartype dashboards: power_bi_client.operations.DashboardsOperations
    :ivar tiles: TilesOperations operations
    :vartype tiles: power_bi_client.operations.TilesOperations
    :ivar apps: AppsOperations operations
    :vartype apps: power_bi_client.operations.AppsOperations
    :ivar dataflows: DataflowsOperations operations
    :vartype dataflows: power_bi_client.operations.DataflowsOperations
    :ivar gateways: GatewaysOperations operations
    :vartype gateways: power_bi_client.operations.GatewaysOperations
    :ivar groups: GroupsOperations operations
    :vartype groups: power_bi_client.operations.GroupsOperations
    :ivar capacities: CapacitiesOperations operations
    :vartype capacities: power_bi_client.operations.CapacitiesOperations
    :ivar available_features: AvailableFeaturesOperations operations
    :vartype available_features: power_bi_client.operations.AvailableFeaturesOperations
    :ivar pipelines: PipelinesOperations operations
    :vartype pipelines: power_bi_client.operations.PipelinesOperations
    :ivar dataflow_storage_accounts: DataflowStorageAccountsOperations operations
    :vartype dataflow_storage_accounts:
     power_bi_client.operations.DataflowStorageAccountsOperations
    :ivar workspace_info: WorkspaceInfoOperations operations
    :vartype workspace_info: power_bi_client.operations.WorkspaceInfoOperations
    :ivar widely_shared_artifacts: WidelySharedArtifactsOperations operations
    :vartype widely_shared_artifacts: power_bi_client.operations.WidelySharedArtifactsOperations
    :ivar admin: AdminOperations operations
    :vartype admin: power_bi_client.operations.AdminOperations
    :ivar embed_token: EmbedTokenOperations operations
    :vartype embed_token: power_bi_client.operations.EmbedTokenOperations
    :ivar information_protection: InformationProtectionOperations operations
    :vartype information_protection: power_bi_client.operations.InformationProtectionOperations
    :ivar profiles: ProfilesOperations operations
    :vartype profiles: power_bi_client.operations.ProfilesOperations
    :ivar template_apps: TemplateAppsOperations operations
    :vartype template_apps: power_bi_client.operations.TemplateAppsOperations
    :ivar scorecards: ScorecardsOperations operations
    :vartype scorecards: power_bi_client.operations.ScorecardsOperations
    :ivar goals: GoalsOperations operations
    :vartype goals: power_bi_client.operations.GoalsOperations
    :ivar goals_status_rules: GoalsStatusRulesOperations operations
    :vartype goals_status_rules: power_bi_client.operations.GoalsStatusRulesOperations
    :ivar goal_values: GoalValuesOperations operations
    :vartype goal_values: power_bi_client.operations.GoalValuesOperations
    :ivar goal_notes: GoalNotesOperations operations
    :vartype goal_notes: power_bi_client.operations.GoalNotesOperations
    ...
    def __init__(
        self, credential: "TokenCredential", *, endpoint: str = "https://api.powerbi.com", **kwargs: Any
    ) -> None:
